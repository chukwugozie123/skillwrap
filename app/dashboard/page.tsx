...
//     } catch {
//       alert("Failed to save mode. Try again.");
//     } finally {
//       setSavingMode(false);
//     }
//   }
...
//           <div className="w-full max-w-md p-8 rounded-3xl text-white
//             bg-gradient-to-br from-[#020617] via-[#0b1220] to-[#1e1b4b]
//             border border-blue-500/30
//             shadow-[0_0_40px_rgba(59,130,246,0.45)]">

//             <h2 className="text-2xl font-bold text-center text-blue-300 mb-2">
//               How do you want to use Skillwrap?
//             </h2>
...
//             {[
//               ["learning", "Learning", "Discover and learn skills"],
//               ["teaching", "Teaching", "Share and teach your skills"],
//               ["exchanging", "Exchanging", "Learn and teach via exchange"],
//             ].map(([value, title, desc]) => (
//               <label
//                 key={value}
//                 className={`block p-4 mb-3 rounded-2xl cursor-pointer border
//                 ${
//                   selectedMode === value
