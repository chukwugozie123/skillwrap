...
export default function ProfilePage() {
  ...
  console.log(skillsWithReviews, data, 'checking user profile info...')
  ...
  <div className="min-h-screen bg-gradient-to-br from-[#020617] via-[#050b2e] to-[#020617] text-white px-6 py-12">
    ...
    <div className="max-w-7xl mx-auto space-y-20">
      ...
      >
        ...
        <div className="relative z-10 p-10 flex flex-col md:flex-row gap-10 items-center">
          ...
          <div className="relative shrink-0">
            ...
            <Image
              src={(profile.img_url?.trim() || "/avatar.png")}
              alt="avatar"
              width={150}
              height={150}
              unoptimized
          ...
          <div className="flex-1 space-y-4 text-center md:text-left">
            <div className="flex flex-col md:flex-row md:items-center gap-3">
              ...
              <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                {Array.isArray(skillsWithReviews) &&
                  skillsWithReviews.map(
                    (skill) =>
                      skill.user_mode && (
                        <span
                          key={skill.skill_id}
      ...
      <section className="grid grid-cols-2 md:grid-cols-4 gap-6">
        ...
        <StatCard icon={<XCircle />} label="Cancelled" value={stats.cancelled_exchanges} color="from-red-500 to-rose-500" />
              ...
              return (
                ...
                >
                  <Link href={`/skills/${skill.skill_id}`} className="relative block">
                    <Image
                      src={(skill.skill_img?.trim() || "/skill-placeholder.jpg")}
                      alt={skill.title}
                      width={500}
                      height={260}
                  ...
                  <div className="p-6 flex-1 flex flex-col justify-between space-y-5">
                    ...
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="text-gray-400">
                        {skill.review_count || 0} review
                        {(skill.review_count || 0) !== 1 && "s"}
                      </span>
                    </div>
                    ...
                    {Array.isArray(skill.reviews) && skill.reviews.length > 0 && (
                      <div className="space-y-3 max-h-40 overflow-y-auto pr-2">
                        {skill.reviews.map((review) => (
                          <div
                            key={review.id}
                            className="flex gap-3 bg-black/30 border border-white/10 rounded-xl p-3"
                          >
                            <Image
                              src={(review.reviewer_avatar?.trim() || "/avatar.png")}
