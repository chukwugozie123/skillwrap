...
// see 2 and 4 and this is how the dashboard code for exchnaging skills should be just write the onw for learning and teaching u get.. etc and also imporv edieisgn add more coolors i know the code would be much os u can psplit into components
