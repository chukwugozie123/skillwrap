...
async function FormSubmit(prevState: any, formData: FormData) {
  const data = Object.fromEntries(formData.entries()); // convert FormData → object
...
// {/* <div className="flex items-center justify-center min-h-screen bg-gradient-to-tr from-[#0f172a] via-[#1e293b] to-[#0f172a]">  */}
...
// // import { useActionState, useActionStatus } from "react"; // ✅ Updated imports
...
// function LoginForm() {
//   const [state, formAction] = useActionState(FormSubmit, { message: "" }); // ✅ updated
//   const { pending } = useActionStatus(); // ✅ updated
//   const router = useRouter();
...
//         <div className="space-y-3">
//           <button className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-gradient-to-r from-red-500 via-pink-600 to-black text-white font-semibold shadow-md hover:scale-[1.03] hover:shadow-pink-500/40 transition">
//             <i className="bx bxl-google text-xl"></i> Sign up with Google
//           </button>

//           <button className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-gradient-to-r from-gray-700 via-gray-900 to-black text-white font-semibold shadow-md hover:scale-[1.03] hover:shadow-gray-500/40 transition">
//             <i className="bx bxl-github text-xl"></i> Sign up with GitHub
//           </button>
//         </div>
