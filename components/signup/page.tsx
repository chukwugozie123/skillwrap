...
//   return (
//     <div className="flex min-h-screen bg-gradient-to-tr from-[#0f172a] via-[#1e293b] to-[#0f172a] p-6">
//       {/* Left side image / illustration */}
//       <div className="hidden md:flex flex-1 justify-center items-center">
// {/* <Image
//   src="https://cdn.pixabay.com/photo/2017/01/31/21/23/sign-up-illustration-2026123_1280.png"
...
//         <form
//           onSubmit={handleSubmit}
//           className="w-full max-w-lg bg-white/10 backdrop-blur-xl border border-white/20 shadow-xl rounded-3xl p-8 text-white space-y-4"
//         >
...
//           <Input label="Username" value={username} onChange={setUsername} />
//           <Input label="Email" type="email" value={email} onChange={setEmail} />
//           <Input label="Referral Code" value={referralCode} onChange={setReferralCode} placeholder="Optional" />
//         </div>
